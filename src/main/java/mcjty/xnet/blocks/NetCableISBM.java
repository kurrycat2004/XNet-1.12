...
public class NetCableISBM implements ISmartBlockModel {

    public static final ModelResourceLocation modelResourceLocation = new ModelResourceLocation(XNet.MODID + ":netcable");
    ...
    public IBakedModel handleBlockState(IBlockState state) {
        ...
        Boolean north = extendedBlockState.getValue(NetCableBlock.NORTH);
        Boolean south = extendedBlockState.getValue(NetCableBlock.SOUTH);
        Boolean west = extendedBlockState.getValue(NetCableBlock.WEST);
        Boolean east = extendedBlockState.getValue(NetCableBlock.EAST);
        Boolean up = extendedBlockState.getValue(NetCableBlock.UP);
        Boolean down = extendedBlockState.getValue(NetCableBlock.DOWN);
    ...
    public class BakedModel implements IBakedModel {
        ...
        public BakedModel(boolean north, boolean south, boolean west, boolean east, boolean up, boolean down) {
            sprite = Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite(XNet.MODID + ":blocks/netcable");
            this.north = north;
            this.south = south;
            this.west = west;
            this.east = east;
