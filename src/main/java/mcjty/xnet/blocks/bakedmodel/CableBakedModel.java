package mcjty.xnet.blocks.bakedmodel;
...
public class CableBakedModel implements IBakedModel {
    ...
    public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(XNet.MODID + ":" + CableModelBlock.CABLEMODELBLOCK);
    ...
    public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
        ...
        Boolean north = extendedBlockState.getValue(CableModelBlock.NORTH);
        Boolean south = extendedBlockState.getValue(CableModelBlock.SOUTH);
        Boolean west = extendedBlockState.getValue(CableModelBlock.WEST);
        Boolean east = extendedBlockState.getValue(CableModelBlock.EAST);
        Boolean up = extendedBlockState.getValue(CableModelBlock.UP);
        Boolean down = extendedBlockState.getValue(CableModelBlock.DOWN);
