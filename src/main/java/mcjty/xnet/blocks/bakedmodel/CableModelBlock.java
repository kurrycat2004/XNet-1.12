...
public class CableModelBlock extends CompatBlock {
    ...
    public static final String CABLEMODELBLOCK = "netcable";

    public CableModelBlock() {
        super(Material.ROCK);
        setUnlocalizedName(XNet.MODID + "." + CABLEMODELBLOCK);
        setRegistryName(CABLEMODELBLOCK);
    ...
    public void initModel() {
        ...
        StateMapperBase ignoreState = new StateMapperBase() {
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState iBlockState) {
                return CableBakedModel.BAKED_MODEL;
            }
        };
    ...
    public void initItemModel() {
        ...
        Item itemBlock = Item.REGISTRY.getObject(new ResourceLocation(XNet.MODID, CABLEMODELBLOCK));
    ...
    private boolean isSameBlock(IBlockAccess world, BlockPos pos) {
        return world.getBlockState(pos).getBlock() == ModBlocks.cableBlock;
    }
