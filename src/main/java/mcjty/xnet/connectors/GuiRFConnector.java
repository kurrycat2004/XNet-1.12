...
public class GuiRFConnector extends GuiItemScreen {

    private BlockPos pos;

    public GuiRFConnector(BlockPos pos) {
        super(XNet.instance, XNet.networkHandler.getNetworkWrapper(), 390, 230, GuiProxy.GUI_RFCONNECTOR, "rfconnector");
        this.pos = pos;
    }
